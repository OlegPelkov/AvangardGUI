...
public class FunLevelGauge extends Region {
    private static final double          PREFERRED_WIDTH  = 90;
    ...
    private static final double          MAXIMUM_WIDTH    = 90;
    ...
    private void initGraphics() {
        ...
        ring.setStroke(Paint.valueOf("linear-gradient(red, transparent)"));
        ring.setStrokeWidth(8.0);
        ring.setOpacity(0.0);
        ...
        mask = new Circle(PREFERRED_WIDTH * 0.5, PREFERRED_WIDTH * 0.5, PREFERRED_WIDTH * 0.45);
        canvas.setClip(mask);
    ...
    public void setLevel(final double LEVEL) {
        ...
        if(LEVEL > 0.2){
            ...
            text.setFill( Color.MEDIUMSPRINGGREEN);
        }
    ...
    private void impulse() {
        int forceRange = 1; // -value to +value
    ...
    private void resize() {
        ...
        if (width > 0 && height > 0) {
            ...
            text.setFont(Fonts.digital(size * 0.3));
            text.setY(size * 0.5);
            text.setX((size - text.getLayoutBounds().getWidth()) * 0.5);
